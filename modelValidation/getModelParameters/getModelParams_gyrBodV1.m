function [modelParams] = getModelParams_gyrBodV1(data, Trial, k, WS, w, walkVel, BMthr, dt, plotIO)
...
Pga = ga(@(p)compareModelPerStrideGA_GyrBod(p, p_bio, p_spring, w, k, xMeas, walkVel, gaitCycle, bound, LgrfPos, RgrfPos, LgrfVec, RgrfVec, LgrfMag, RgrfMag, LLML, LGTR, RLML, RGTR, dt, false),...
    11,[],[],[],[],...
    lb,...
    ub, [],[],...
...
Popt = fmincon(@(p)compareModelPerStrideFMC_GyrBod(p, p_bio, w, k, xMeas, walkVel, gaitCycle, bound, LgrfPos, RgrfPos, LgrfVec, RgrfVec, LgrfMag, RgrfMag, LLML, LGTR, RLML, RGTR, dt, false),...
    Pinit, [],[],[],[],...
...
%%
if plotIO
resnormGyrbod = compareModelPerStrideFMC_GyrBod(Popt, p_bio, w, k, xMeas, walkVel, gaitCycle, bound, LgrfPos, RgrfPos, LgrfVec, RgrfVec, LgrfMag, RgrfMag, LLML, LGTR, RLML, RGTR, dt, plotIO)
drawnow
end
