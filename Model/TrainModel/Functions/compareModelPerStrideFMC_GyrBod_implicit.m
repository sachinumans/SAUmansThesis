function [ResNorm] = compareModelPerStrideFMC_GyrBod_implicit(p, pars, w, k, xMeas, walkVel, gaitCycle, bound,...
    ...
    switch gaitCycle(1)
        case "lSS"
            ...
            for ki = ki:k_end
                ...
                xModel(:,ki+1) = xModel(:,ki) + dt*ImplicitEoM_gyrBod_dyns(xModel(:,ki), lFcur', pars, "LSS");
        ...
        case "rSS"
            ...
            for ki = ki:k_end
                ...
                xModel(:,ki+1) = xModel(:,ki) + dt*ImplicitEoM_gyrBod_dyns(xModel(:,ki), rFcur', pars, "RSS");
        ...
        case "lDSr"
            ...
            for ki = ki:k_end
                lFcur = lF-walkVel(1:2)*dt*(ki-k1);
                rFcur = rF-walkVel(1:2)*dt*(ki-k1);
                xModel(:,ki+1) = xModel(:,ki) + dt*ImplicitEoM_gyrBod_dyns(xModel(:,ki), [lFcur', rFcur'], pars, "lDSr");
        ...
        case "rDSl"
            ...
            for ki = ki:k_end
                lFcur = lF-walkVel(1:2)*dt*(ki-k1);
                rFcur = rF-walkVel(1:2)*dt*(ki-k1);
                xModel(:,ki+1) = xModel(:,ki) + dt*ImplicitEoM_gyrBod_dyns(xModel(:,ki), [lFcur', rFcur'], pars, "rDSl");
