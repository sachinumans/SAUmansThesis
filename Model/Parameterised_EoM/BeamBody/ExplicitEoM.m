...
% % matlabFunction(Ads,'File','linAds','Vars', vDS)
% % matlabFunction(Bds,'File','linBds','Vars', vDS)
% 
% toc
% disp("Double Stance completed")
...
toc
disp("lDSr split front/back leg completed")
...
toc
disp("rDSl split front/back leg completed")